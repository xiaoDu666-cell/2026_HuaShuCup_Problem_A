...
# --------------------
def evaluate_point(fA, fB, trials, seed_base, processes:int=4, batch_size:int=0, pool: Optional[Pool]=None):
    """
...
# --------------------
def coarse_grid_search(fA_min, fA_max, fB_min, fB_max, nA, nB, trials, seed_base, out_csv, processes=4, resume_df:Optional[pd.DataFrame]=None, pool: Optional[Pool]=None, batch_size:int=0):
...
def refine_near_candidates(df_coarse, threshold, fine_trials, seed_base, out_csv, processes=4, resume_df:Optional[pd.DataFrame]=None, pool: Optional[Pool]=None, batch_size:int=0):
